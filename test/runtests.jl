...
# !!! Main.UserApp is configured as an alias for Main.ScoringEngineDemo and you might encounter it in some tests
using Main.ScoringEngineDemo, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "ScoringEngineDemo tests" begin
  @includetests ARGS
end
